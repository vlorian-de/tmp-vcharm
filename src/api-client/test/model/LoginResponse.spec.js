...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VcharmDriverApi.LoginResponse();
  });
  ...
  describe('LoginResponse', function() {
    it('should create an instance of LoginResponse', function() {
      ...
      //var instance = new VcharmDriverApi.LoginResponse();
      //expect(instance).to.be.a(VcharmDriverApi.LoginResponse);
    });
    ...
    it('should have the property isChangePasswordRequired (base name: "isChangePasswordRequired")', function() {
      // uncomment below and update the code to test the property isChangePasswordRequired
      //var instance = new VcharmDriverApi.LoginResponse();
      //expect(instance).to.be();
    });
