...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VcharmDriverApi.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instance = new VcharmDriverApi.ChangePasswordRequest();
      //expect(instance).to.be.a(VcharmDriverApi.ChangePasswordRequest);
    });
    ...
    it('should have the property codeChangePassword (base name: "codeChangePassword")', function() {
      // uncomment below and update the code to test the property codeChangePassword
      //var instance = new VcharmDriverApi.ChangePasswordRequest();
      //expect(instance).to.be();
    });
