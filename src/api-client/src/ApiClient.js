...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api-driverapp.vcharm.vector.com/driver-api/zsasmjc3q9') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api-driverapp.vcharm.vector.com/driver-api/zsasmjc3q9
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://api-driverapp.vcharm.vector.com/driver-api/{organization_id}",
              'description': "Production Server",
              'variables': {
                organization_id: {
                    'description': "Organization ID",
                    'default_value': "zsasmjc3q9",
                  }
                }
            }
      ];
